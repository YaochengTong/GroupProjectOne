...
public class VisaStatusDaoImpl implements IVisaStatusDao {
    ...
    @Async("taskExecutor")
    @Transactional
    public CompletableFuture<Integer> getVisaAuthorizationLeftDay(Integer employeeId) {
        Session session = sessionFactory.getCurrentSession();
        ...
        return CompletableFuture.completedFuture(leftDay);
    }

    @Override
    @Async("taskExecutor")
    @Transactional
    public CompletableFuture<String> getVisaTypeByEmployeeId(Integer employeeId) {
        Session session = sessionFactory.getCurrentSession();
        ...
        return CompletableFuture.completedFuture(visaType);
    }
